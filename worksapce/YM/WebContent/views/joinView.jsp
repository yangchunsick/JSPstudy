...
<head>
    ...
    <link rel="stylesheet" href="./css/joinView.css">
	<script src="./js/joinView.js"></script>
</head>
<body>
            ...
            <form id="join_form" action="#" method="post">
                ...
                <div class="join_row">
                    ...
                    <div class="ps_box">
                        ...
                        <span class="step_url">@coffee.com</span>
                    </div>
                    <p id="id_check"></p>
                </div>
                ...
                <div class="join_row">
                    ...
                    <div class="ps_box">
                        ...
                        <span id="pwd_icon" class="step_url pwd_icon"><i class="fas fa-unlock"></i></span>
                    </div>
                    <p id="pwd_check"></p>
                </div>
                ...
                <div class="join_row">
                    ...
                    <div class="ps_box">
                        ...
                        <span id="re_pwd_icon" class="step_url re_pwd_icon"><i class="far fa-check-circle"></i></span>
                    </div>
                    <p id="re_pwd_check"></p>
                </div>
                <br>
